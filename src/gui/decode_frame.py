...
class DecodeFrame(ctk.CTkFrame):
    ...
    def _setup_text_tab(self):
        ...
        self.lbl_stego_text = self._setup_stego_selector(tab, lambda: self._on_stego_selected(self.lbl_stego_text))
    ...
    def _setup_image_tab(self):
        ...
        self.lbl_stego_img = self._setup_stego_selector(tab, lambda: self._on_stego_selected(self.lbl_stego_img))
